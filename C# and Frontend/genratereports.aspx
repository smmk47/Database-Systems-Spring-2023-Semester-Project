<%@ Page Language="C#" AutoEventWireup="true" CodeFile="genratereports.aspx.cs" Inherits="genratereports" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="admin-info">Logged in as:
                <asp:Label ID="Label1" runat="server" Text="Admin Name"></asp:Label></div>
            ...
            <asp:Button runat="server" Text="Logs Report" CssClass="button" OnClick="LogsReport_Click" />
        </div>
